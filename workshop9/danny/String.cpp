...
namespace sict {
   ...
   bool String::operator==(const String& s2) const {
      bool returnv = false;
      if (strcmp(this->m_pString, s2.m_pString) == 0) returnv = true;
      return returnv;
   }
   ...
   String String::operator+(const String& s2) const {
      String dummy("");
      strcpy(dummy.m_pString, this->m_pString);
   ...
   // clean up the internal string buffer  
   //     
   std::ostream& String::getString(std::ostream& ostr) const {
      ostr << m_pString;
      return ostr;
   }
   std::ostream& operator<<(std::ostream& ostream, const String &s) {
      return s.getString(ostream);
   }
