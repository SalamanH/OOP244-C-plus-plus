...
namespace sict{
	...
	{
		return (strcmp(m_pString, "")) ? true : false;
	}
	...
	{
		return (strcmp(m_pString, s2.m_pString)) ? true : false;
	}
	...
	{
		String dummy("");
		strcpy(dummy.m_pString, m_pString);
		char* returnv = strcat(dummy.m_pString, s2.m_pString);
